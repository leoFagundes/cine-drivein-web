...
export const Input = ({ value, placeholder, onChange, errorLabel, type, marginTop, marginBottom, caption }: InputType) => {
    ...
    return (
        <div style={{ marginTop: marginTop, marginBottom: marginBottom }} className={styles.container}>
